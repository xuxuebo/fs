...
public class ZipVideoProcessor extends AbstractProcessor {
    ...
    protected void submitToRedis(FsFile fsFile) {
        ...
        commonJedis.sadd(RedisKey.FS_QUEUE_NAME_LIST, RedisKey.FS_ZIP_VIDEO_QUEUE_LIST);
        String fsFileId = fsFile.getId();
        //当重复提交时，防止重复处理
        //commonJedis.lrem(RedisKey.FS_ZIP_VIDEO_QUEUE_LIST, 0, fsFileId);
        commonJedis.lpush(RedisKey.FS_ZIP_VIDEO_QUEUE_LIST, fsFileId);
    ...
    public void process(FsFile fsFile) throws Exception {
        ...
        try {
            ...
            commonJedis.srem(RedisKey.FS_ZIP_VIDEO_QUEUE_LIST, fsFile.getId());
